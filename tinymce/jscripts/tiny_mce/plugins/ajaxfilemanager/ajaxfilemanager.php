				...
				<table cellpadding="0" cellspacing="0" class="tableSummary" id="folderInfo">
					<tbody>
						<tr>
							...
							<td colspan="3" id="folderPath"><?php echo transformFilePath($folderInfo['path']); ?></th>
						</tr>
						<tr>
  	...
  	<div class="jqmContainer">
  		...
  		<div class="jqmBody">
		  	...
		  	<table class="tableForm" cellpadding="0" cellspacing="0">
		  		<thead>
		  			<tr>
		  				<th colspan="2"><?php echo FILE_FORM_TITLE; ?><a class="action" href="#" title="<?php echo FILE_LBL_MORE;  ?>" onclick="return addMoreFile();"><span class="addMore">&nbsp;</span></a> klik <b><a href="#" onclick="tb_remove();"><?php echo LBL_ACTION_CLOSE; ?> </a></b> untuk lihat file <span class="uploadProcessing" style="display:none">&nbsp;<span></th>
