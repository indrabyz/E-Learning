...
if ($_GET['module']=="kategori"){include "kategori.php";}
if ($_GET['module']=="topik"){include "topik.php";}
if ($_GET['module']=="chat"){include "chat.php";}
if ($_GET['module']=="komentar"){include "komentar.php";}
?>
