...
if ($module=='quiz' AND $act=='input_topikquiz'){
    ...
    $pengajar = mysql_query("SELECT * FROM siswa WHERE id_siswa = '$data[id_pengajar]'");
  ...
  header('location:'.$dir.'.php?module='.$module);
}
...
elseif($module=='quiz' AND $act=='inputnilai'){
    ...
    header('location:'.$dir.'.php?module=quiz&act=daftarsiswayangtelahmengerjakan&id='.$_POST[id_tq]);
}
...
elseif($module=='quiz' AND $act=='input_quizesay'){
  ...
  if (!empty($lokasi_file)){
        if (file_exists($direktori_file)){
            ...
            window.location=(href='$dir.php?module=quiz&&act=buatquizesay&id=$_POST[id]')</script>";
        }else{
...
header('location:'.$dir.'.php?module=daftarquizesay&act=daftarquizesay&id='.$_POST[id]);
}
...
elseif($module=='quiz' AND $act=='input_quizpilganda'){
  ...
  if (!empty($lokasi_file)){
      if (file_exists($direktori_file)){
            echo "<script>window.alert('Nama file sudah ada, mohon diganti dulu');
            window.location=(href='$dir.php?module=buatquizpilganda&&act=buatquizpilganda&id=$_POST[id]')</script>";
        }else{
            if($tipe_file != "image/jpeg" AND
               $tipe_file != "image/jpg"
            ){
    ...
    header('location:'.$dir.'.php?module=daftarquizpilganda&act=daftarquizpilganda&id='.$_POST[id]);
}
...
elseif($module=='quiz' AND $act=='edit_quizesay'){
  ...
  if (!empty($lokasi_file)){
        if (file_exists($direktori_file)){
            echo "<script>window.alert('Nama file sudah ada, mohon diganti dulu');
            window.location=(href='$dir.php?module=daftarquizesay&act=daftarquizesay&id=$_POST[topik]')</script>";
        }else{
            if($tipe_file != "image/jpeg" AND
               $tipe_file != "image/jpg"               
            ){
    ...
    header('location:'.$dir.'.php?module=daftarquizesay&act=daftarquizesay&id='.$_POST[topik]);
}
...
elseif($module=='quiz' AND $act=='hapusquizesay'){
     ...
     header('location:'.$dir.'.php?module=daftarquizesay&act=daftarquizesay&id='.$_GET[id_topik]);
}
...
elseif($module=='quiz' AND $act=='edit_quizpilganda'){
  ...
  if (!empty($lokasi_file)){
      if (file_exists($direktori_file)){
            echo "<script>window.alert('Nama file sudah ada, mohon diganti dulu');
            window.location=(href='$dir.php?module=daftarquizpilganda&act=daftarquizpilganda&id=$_POST[topik]')</script>";
        }else{
            if($tipe_file != "image/jpeg" AND
               $tipe_file != "image/jpg"
            ){
     ...
     header('location:'.$dir.'.php?module=daftarquizpilganda&act=daftarquizpilganda&id='.$_POST[topik]);
}
...
elseif($module=='quiz' AND $act=='hapusquizpilganda'){
    $cek = mysql_query("SELECT * FROM quiz_pilganda WHERE id_quiz = '$_GET[id]'");
     ...
     header('location:'.$dir.'.php?module=daftarquizpilganda&act=daftarquizpilganda&id='.$_GET[id_topik]);
}
