...
elseif ($module=='admin' AND $act=='input_pengajar'){
  ...
  $cek_nip = mysql_query("SELECT * FROM siswa WHERE nis='$_POST[nip]' and level='dosen'");
...
elseif ($module=='admin' AND $act=='update_pengajar'){
  ...
  $cek_nip = mysql_query("SELECT * FROM siswa WHERE id_siswa='$_POST[id]'");
  ...
  elseif(!empty($lokasi_file) AND empty($_POST[password])){
      if (file_exists($direktori_file)){
            echo "<script>window.alert('Nama file gambar sudah ada, mohon diganti dulu');
            window.location=(href='$dir.php?module=admin&act=editpengajar')</script>";
            }else{
                if($tipe_file != "image/jpeg" AND
                    $tipe_file != "image/jpg"
                ){
                ...
                UploadImage($nama_file);
                mysql_query("UPDATE siswa SET nis  = '$_POST[nip]',
                                  nama_lengkap   = '$_POST[nama_lengkap]',
                                  username_login = '$_POST[username]',
                                  alamat         = '$_POST[alamat]',
                                  tempat_lahir   = '$_POST[tempat_lahir]',
  ...
  elseif(empty($lokasi_file) AND !empty($_POST[password])){
    ...
    header('location:'.$dir.'.php?module=admin&act=pengajar');
  }
  elseif($_POST['nip']!= $ketemu['nis']){
  
      $cek_nip = mysql_query("SELECT * FROM siswa WHERE nis = '$_POST[nip]'");
      ...
      if(empty($c)){
        ...
        elseif(!empty($lokasi_file) AND empty($_POST[password])){
             if (file_exists($direktori_file)){
                    echo "<script>window.alert('Nama file gambar sudah ada, mohon diganti dulu');
                    window.location=(href='$dir.php?module=admin&act=pengajar')</script>";
             }else{
                if($tipe_file != "image/jpeg" AND
                    $tipe_file != "image/jpg"
                ){
        ...
        window.location=(href='$dir.php?module=admin')</script>";
      }
  }
}
...
elseif ($module=='admin' AND $act=='hapusdosen'){
...
elseif ($module=='admin' AND $act=='update_pengajar2'){
  ...
  elseif(!empty($lokasi_file) AND empty($_POST[password])){
      if (file_exists($direktori_file)){
            echo "<script>window.alert('Nama file gambar sudah ada, mohon diganti dulu');
            window.location=(href='../../../media.php')</script>";
            }else{
                if($tipe_file != "image/jpeg" AND
                    $tipe_file != "image/jpg"
                ){
  ...
  elseif($_POST['nip']!= $ketemu['nis']){
      $cek_nip2 = mysql_query("SELECT * FROM siswa WHERE nis = '$_POST[nip]'");
